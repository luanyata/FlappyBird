package br.com.luanyata.flappybird;
...
public class FlappyBird extends ApplicationAdapter {
    ...
    private float posicaoInicialVertival;
    ...
    public void create() {
        ...
        posicaoInicialVertival = alturaDispositivo / 2;
    ...
    public void render() {
        ...
        //Otimização para redução de recursos
        ...
        if (estadoJogo == 0) {
            ...
            velocidadeQueda++;
            if (posicaoInicialVertival > 0 || velocidadeQueda < 0)
                posicaoInicialVertival -= velocidadeQueda;
        ...
        //Configura os dados de projeção da câmera
        ...
        batch.draw(passaros[(int) variacao], 120, posicaoInicialVertival);
        ...
        passaroCirculo.set(120 + passaros[0].getWidth() / 2, posicaoInicialVertival + passaros[0].getHeight() / 2, passaros[0].getWidth() / 2);
        ...
        //<editor-fold desc="Desenha as formas dos objetos na tela">
